    ...
    return (
        ...
        <div className="flex flex-col justify-center">
            ...
            <div className="w-full flex flex-col space-y-2 p-3">
                ...
                <h3 className="font-bold text-gray-800 text-lg">{nameReserve} - {reserve_id}</h3>
                ...
                <span className="font-medium flex text-left">
                    ...
                    <span className="font-normal text-gray-600 text-base ml-3"> {formatTime(start_time)} - {formatTime(end_time)}</span>
                </span>
