...
const AccordionItem = ({ id, heading, children, isOpen, onToggle }) => (
  <div>
    <h2 id={heading}>
      <button
        type="button"
        className={`flex items-center justify-between w-full p-4 font-medium rtl:text-right text-gray-500 border ${isOpen ? 'border-b-0' : ''} border-gray-200 bg-white rounded-t-xl focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3`}
        onClick={() => onToggle(id)}
      ...
      >
        <span className="flex items-center">
          ...
          <span className="text-red-500 text-left font-semibold">
          {heading}
          </span>
        </span>
        <svg
