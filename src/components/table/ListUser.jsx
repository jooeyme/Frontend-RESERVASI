...
import { Tabs, Label, TextInput, Modal, Select } from "flowbite-react";
import {
  HiUserCircle,
  HiOutlineTrash,
  HiOutlinePencilAlt,
...
import {
  ...
  updateUser,
  getUserById,
} from "../../modules/fetch/user";
import {
  getAdmin,
  deleteAdmin,
  updateAdmin,
  getAdminById,
} from "../../modules/fetch/admin";
                ...
                <tbody className="text-blue-gray-900">
                  {user.map((user, index) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-4">{user.NIM}</td>
                      <td className="py-3 px-4">{user.alamat}</td>
                      <td className="flex py-3 px-4">
                        <a
                          onClick={() => {
                            setOpenModal(true), handleEditUserClick(user.id);
                          }}
                ...
                <Modal.Body>
                  <form onSubmit={handleSubmitUser} className="p-4 md:p-5">
                    <div className="grid gap-4 mb-4 grid-cols-2">
                      ...
                      <div>
                        <div className="mb-2 block">
                          <Label htmlFor="NIM" value="NIM/NIP/NIK" />
                        </div>
                        <TextInput
                          id="NIM"
                          name="NIM"
                ...
                <tbody className="text-blue-gray-900">
                  {admin.map((admin, index) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-4">{admin.email_admn}</td>
                      ...
                      <td className="flex py-3 px-4">
                        <a
                          onClick={() => {
                            setOpenModal1(true), handleEditAdminClick(admin.id);
                          }}
                          className="text-blue-600 hover:text-blue-800"
                        >
                          <HiOutlinePencilAlt size={30} />
                      ...
                      <div>
                        ...
                        <Select 
                          ...
                          required>
                            ...
                            <option value='admin_staff'>Admin Laboratorium</option>
                            <option value='admin_tu'>Admin TU</option>
                            <option value='admin_mm'>Admin Multimedia</option>
